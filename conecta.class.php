...
* @link https://drive.google.com/file/d/0B2DBrbHSolGEQjdUWXhucVMtM00/edit?usp=sharing
* @version 7.2
* @since 01/12/2011
* @lastUpdate 09/09/2014
*/
class Conecta
{
    /**
    ...
    */
    ...
    { 
        ...
        {
            // Conectando
            $this->pdoConecta = new PDO( $acesso, $this->user, $this->pass ) ;
            $this->pdoConecta->setAttribute( PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION );
